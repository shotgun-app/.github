...
- We have meetings on a weekly basis where we sync with each other. Everyone presents what he/she is working on, what he/she worked on, and if there are any blockers. The meetings are held on Discord server.
...
- The item are done when it meets acceptance criteria defined in the issue
